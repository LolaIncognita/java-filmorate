...
public class FilmController {
    ...
    public Film create(@RequestBody Film filmFromRequest) {
        ...
        if (filmFromRequest.getDescription().length() > MAX_DESCRIPTION_LENGTH) {
        ...
        if (filmFromRequest.getReleaseDate().isBefore(MIN_RELEASE_DATE)) {
        ...
        if (filmFromRequest.getDuration() <= 0) {
